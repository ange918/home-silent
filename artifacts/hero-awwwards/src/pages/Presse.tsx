  ...
  return (
    <main className="mx-auto max-w-[1400px] px-6 pt-12">
      <div className="text-center">
        <div className="text-[12px] uppercase tracking-[0.18em] text-[#7a7a78]">— Presse & distinctions</div>
        <h1
        ...
        <p className="mx-auto mt-6 max-w-[600px] text-[15.5px] leading-[1.55] text-[#3a3a38]">
          Pour toute demande presse, écrivez à <a className="underline" href="mailto:presse@maison-silencieuse.fr">presse@maison-silencieuse.fr</a>.
      ...
      <section className="mt-16">
        ...
        <div className="mt-6 grid grid-cols-1 divide-y divide-black/10 border-y border-black/10">
          {features.map((f) => (
            <div key={f.title} className="grid grid-cols-12 items-center gap-6 py-7">
      ...
      <section className="mt-24">
        ...
        <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2">
          {awards.map((a) => (
            <div key={a.name} className="flex items-baseline gap-6 border-b border-black/10 pb-6">
      ...
      {/* Press kit */}
      <section className="mt-24 rounded-[8px] border border-black/10 bg-white p-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          <div className="flex flex-col items-start justify-center gap-3">
            <button className="inline-flex items-center gap-2 rounded-full bg-[#111] px-5 py-3 text-[13px] font-semibold text-white" data-testid="button-presskit-fr">
              Télécharger — FR (42 Mo)
            </button>
            <button className="inline-flex items-center gap-2 rounded-full border border-[#111] bg-white px-5 py-3 text-[13px] font-semibold text-[#111]" data-testid="button-presskit-en">
              Download — EN (42 MB)
            </button>
          </div>
        </div>
