  ...
  return (
    <main className="mx-auto max-w-[1400px] px-6 pt-12">
      <div className="text-center">
        <div className="text-[12px] uppercase tracking-[0.18em] text-[#7a7a78]">— Premier contact</div>
        <h1
        ...
        <p className="mx-auto mt-6 max-w-[640px] text-[15.5px] leading-[1.55] text-[#3a3a38]">
      ...
      <div className="mt-16 grid grid-cols-1 gap-12 md:grid-cols-12">
        ...
        <form className="md:col-span-7">
            ...
            <div className="flex flex-wrap gap-2">
              {subjects.map((s) => (
                <button
                  key={s}
                  type="button"
                  className="rounded-full border border-black/15 bg-white px-3.5 py-2 text-[13px] font-medium text-[#111] hover:border-[#111] hover:bg-[#111] hover:text-white"
          ...
          <div className="mt-6">
            ...
            <textarea
              ...
              className="w-full rounded-[6px] border border-black/15 bg-white p-4 text-[14.5px] leading-[1.6] text-[#111] outline-none focus:border-[#111]"
          ...
          <button
            type="button"
            className="mt-6 inline-flex items-center gap-2 rounded-full bg-[#111] px-6 py-3.5 text-[14px] font-semibold text-white hover:bg-black/80"
        ...
        <aside className="md:col-span-5">
          ...
          <div className="mt-5 rounded-[8px] bg-white p-7">
          ...
          <div className="mt-5 rounded-[8px] bg-[#0e0e0e] p-7 text-white">
...
function Field({
  ...
  return (
    <label className="block">
      ...
      <input
        type={type}
        className="h-11 w-full rounded-[6px] border border-black/15 bg-white px-3.5 text-[14.5px] text-[#111] outline-none focus:border-[#111]"
        data-testid={testId}
      />
    </label>
  );
